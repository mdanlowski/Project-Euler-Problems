...
"""
THIS FILE REQUIRES "primes.csv" in the directory
...
while N < 10000:
	...
	##############################
	print("Runtime: " + str( round( (timeit.default_timer() - start), 6) ))
	f.write(str(N) + "," + str( round( (timeit.default_timer() - start), 6) ) + "\n")
